...
class About extends  React.Component {
  render() {
    return (
        <div id="About" className="section-part">
          <b className="about-title">Description</b>
          ...
          <div className="texts-about responsive-hide">
          ...
          <div className="share-box">
            <h3><b>Share this project in social</b></h3>
            <img src={facebook}/>
            <img src={linkedin}/>
          </div>
        </div>
